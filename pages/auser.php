  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="auser.php" >
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <form class="form-signin" action="auser.php" method="POST" autocomplete="off">
                <?php include('../include/errors.php');?>
                  <div class="text-center mb-4">
                  <h1 class="h2" >Create User</h1>
                  <p>You can create the user's profile in the form below.</p>
                  </div>
            ...
            <div class="form-floating">
              ...
              <p></p>
              <button class="w-100 btn btn-lg btn-update" type="submit" name="cre_usr">CREATE</button>
              </form>
            </div>
            </div>
    </main>
