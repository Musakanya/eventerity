  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      ...
      <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="aprofile.php" >
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <form class="form-signin" action="aprofile.php" method="POST" autocomplete="off">
            ...
            <div class="form-floating">
              ...
              <p></p>
              <button class="w-100 btn btn-lg btn-update" type="submit" name="ad_upd">UPDATE</button>
              </form>
            </div>
            <!-- Change Password -->
            ...
            <form class="form-signin" action="aprofile.php" method="POST" autocomplete="off">
              ...
              <p></p>
              <button class="w-100 btn btn-lg btn-update" type="submit" name="ad_pass">CHANGE PASSWORD</button>
              </form>
            </div>
